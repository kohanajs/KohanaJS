...
import defaultDatabaseAdapter from "./orm/application/classes/ORMAdapterTest";
...
//    import AliasModel from "./orm/application/classes/AliasModel.mjs";
  ...
  test('prepend model prefix path', async () => {
    ...
    try {
      ...
      expect(e.message).toBe('KohanaJS resolve path error: path models/Person.mjs not found. classes , {} ');
    }
  });
